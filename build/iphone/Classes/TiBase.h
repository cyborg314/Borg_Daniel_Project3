...
// in simulator we redefine to format for Borg_Daniel_Project3 Developer console
...
{\
	NSString * exceptionName = [@"org.borg_daniel_project3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.borg_daniel_project3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIBorg_Daniel_Project3NativeItemNone = -1, 
	UIBorg_Daniel_Project3NativeItemSpinner = -2,
	UIBorg_Daniel_Project3NativeItemProgressBar = -3,
	
	UIBorg_Daniel_Project3NativeItemSlider = -4,
	UIBorg_Daniel_Project3NativeItemSwitch = -5,
	UIBorg_Daniel_Project3NativeItemMultiButton = -6,
	UIBorg_Daniel_Project3NativeItemSegmented = -7,
	
	UIBorg_Daniel_Project3NativeItemTextView = -8,
	UIBorg_Daniel_Project3NativeItemTextField = -9,
	UIBorg_Daniel_Project3NativeItemSearchBar = -10,
	
	UIBorg_Daniel_Project3NativeItemPicker = -11,
	UIBorg_Daniel_Project3NativeItemDatePicker = -12,
	
	UIBorg_Daniel_Project3NativeItemInfoLight = -13,
	UIBorg_Daniel_Project3NativeItemInfoDark = -14,
	
	UIBorg_Daniel_Project3NativeItemDisclosure = -15,
	
	UIBorg_Daniel_Project3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Borg_Daniel_Project3 instances of
