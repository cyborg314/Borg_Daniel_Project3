...
//@interface Borg_Daniel_Project3Object : NSObject
//@end

@interface Borg_Daniel_Project3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Borg_Daniel_Project3Object class]])
		{
			for (NSString *key in [[(Borg_Daniel_Project3Object*)o modules] allKeys])
			{
