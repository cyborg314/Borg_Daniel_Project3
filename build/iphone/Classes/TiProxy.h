...
//Rare exceptions to indicate a bug in the _borg_daniel_project3 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Borg_Daniel_Project3 proxies.
 */
