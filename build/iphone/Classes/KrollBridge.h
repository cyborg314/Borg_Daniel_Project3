...
@interface Borg_Daniel_Project3Object : KrollCoverageObject {
#else
@interface Borg_Daniel_Project3Object : KrollObject {
#endif
@private
...
extern NSString * Borg_Daniel_Project3$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Borg_Daniel_Project3Object *_borg_daniel_project3;
    KrollObject* console;
	BOOL shutdown;
